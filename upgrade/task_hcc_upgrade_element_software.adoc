...
NOTE: Ab Element 12.5 werden NetApp HealthTools bei Upgrades der Element Software nicht mehr unterstützt. Bei Element 11.0 oder 11.1 müssen Sie zuerst link:https://docs.netapp.com/us-en/element-software-123/upgrade/task_hcc_upgrade_element_software.html#upgrade-element-software-at-connected-sites-using-healthtools["Upgrade auf Element 12.3.x mit HealthTools"^] und dann mithilfe von NetApp Hybrid Cloud Control auf Element 12.5 oder höher aktualisieren.
...
* *System-Ports*: Bei Upgrade-Nutzung von NetApp Hybrid Cloud Control haben Sie sichergestellt, dass die erforderlichen Ports geöffnet sind. Weitere Informationen finden Sie unter link:../storage/reference_prereq_network_port_requirements.html["Netzwerkports"] .
...
| H610S | 11.7 und früher | 90 Minuten | 40 bis 70 Minuten | 130 bis 160 Minuten müssen Sie ebenfalls für jeden H610S Node benötigen https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/H_Series/NetApp_H610S_storage_node_power_off_and_on_procedure["Führen Sie ein komplettes Herunterfahren des Node durch, und trennen Sie die Stromversorgung"^]. 
|===
+
^1^eine vollständige Matrix der Firmware und Treiber-Firmware für Ihre Hardware finden Sie unter link:../hardware/fw_storage_nodes.html["Unterstützte Storage-Firmware-Versionen für SolidFire Storage-Nodes"].
...
CAUTION: Potenzielle Probleme beim Upgrade von Storage-Clustern mit NetApp Hybrid Cloud Control und ihren Behelfslösungen finden Sie in diesem https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/NetApp_HCI/Potential_issues_and_workarounds_when_running_storage_upgrades_using_NetApp_Hybrid_Cloud_Control["KB-Artikel"^].
...
.. Führen Sie die zusätzlichen Schritte aus, die im erforderlich https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/H_Series/NetApp_H610S_storage_node_power_off_and_on_procedure["KB-Artikel"^] sind, und bestätigen Sie in der Benutzeroberfläche, dass Sie Phase 2 abgeschlossen haben.
...
+
Laden Sie die neueste Storage-Node-Image der Element Software https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["download-Seite"^] herunter.
...
| Wenn Sie ein Upgrade für einen H610S-Cluster durchführen, auf dem eine Element-Version vor 11.8 ausgeführt wird, wird der Status im Antworttext angezeigt `finishedNeedsAck`.Sie müssen für jeden H610S-Speicher-Node weitere Upgrade-Schritte durchführen.  a| 
... Führen Sie hier für jeden Node die zusätzlichen Upgrade-Schritte durch https://kb.netapp.com/Advice_and_Troubleshooting/Hybrid_Cloud_Infrastructure/H_Series/NetApp_H610S_storage_node_power_off_and_on_procedure["KB-Artikel"^].
... Bei Bedarf erneut authentifizieren und *PUT ​/Upgrades/{UpgradeId}* auswählen.
... Wählen Sie *Probieren Sie es aus*.
... Geben Sie die Upgrade-ID des vorherigen Schritts in *UpgradeId* ein.
