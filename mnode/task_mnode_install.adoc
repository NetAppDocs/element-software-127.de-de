...
.Schritte
. Laden Sie die OVA oder ISO für Ihre Installation von der  Seite auf der NetApp Support-Website herunterlink:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Element Software"^]. Die neue OVA enthält ein aktualisiertes SSL-Zertifikat.
+
