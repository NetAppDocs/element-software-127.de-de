...
* link:task_mnode_manage_storage_cluster_assets.html["Erstellen und Managen von Storage-Cluster-Assets"]
* link:../hccstorage/task-hcc-collectlogs.html#use-the-rest-api-to-collect-logs["Verwenden Sie die REST API, um die Protokolle des Element-Systems zu erfassen"]
