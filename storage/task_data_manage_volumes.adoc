...
NOTE: Betriebssysteme unterscheiden sich in der Behandlung geklonter Volumes. VMware ESXi behandelt ein geklontes Volume als Volume Copy oder Snapshot Volume. Das Volume steht als verfügbares Gerät zur Erstellung eines neuen Datenspeichers zur Verfügung. Weitere Informationen zum Einbinden geklonter Volumes und zum Umgang mit Snapshot-LUNs bietet die VMware-Dokumentation zu  https://techdocs.broadcom.com/["Mounten einer VMFS-Datastore-Kopie"^] und  https://techdocs.broadcom.com/["Managen doppelter VMFS-Datenspeicher"^].
