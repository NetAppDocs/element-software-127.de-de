...
NOTE: Weitere Informationen zur Verwendung  anstelle einzelner Volumes finden Sie unter SolidFire Konzepte zu All-Flash-Storagelink:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html#qos-policies["QoS-Richtlinien (QoS"]link:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html["QoS"].
