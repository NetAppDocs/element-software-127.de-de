...
[role="lead"]
Die Web-UI der Element Software verwendet diese `UpdateSnapMirrorRelationship` Methode, um das Zielvolume in einer SnapMirror Beziehung zu einer aktuellen Spiegelung des Quell-Volumes zu machen.
