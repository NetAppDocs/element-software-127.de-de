...
summary: Mit der Methode GetSSLCertificate können Sie das SSL-Zertifikat abrufen, das derzeit auf den Speicherknoten des Clusters aktiv ist. 
---
= GetSSLZertifikat
:allow-uri-read: 
:icons: font
...
Zertifikat
 a| 
Der vollständige PEM-codierte Text des Zertifikats.
 a| 
Zeichenfolge
...
Details
 a| 
Die decodierten Informationen des Zertifikats.
 a| 
JSON Objekt
