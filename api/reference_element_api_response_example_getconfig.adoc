...
summary: Die Methode getconfig gibt eine Antwort zurück, die dem folgenden Beispiel ähnelt. Aufgrund der Länge enthält die Antwort nur Informationen für einen Node des Clusters. 
---
= Getconfig
:allow-uri-read: 
:icons: font
