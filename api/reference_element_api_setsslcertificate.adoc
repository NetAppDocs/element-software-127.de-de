...
summary: Mithilfe der Methode SetSSLCertificate können Sie ein Benutzer-SSL-Zertifikat und einen privaten Schlüssel für die Speicherknoten im Cluster festlegen. 
---
= SetSSLZertifikat
:allow-uri-read: 
:icons: font
