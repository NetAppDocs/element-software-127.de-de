...
NOTE: Über die API stehen Zugriffstypen zur Verfügung, die in der Element UI nicht verfügbar sind.
...
link:../storage/concept_system_manage_manage_cluster_administrator_users.html#view-cluster-admin-details["Informationen zu den in der Element Benutzeroberfläche verfügbaren Zugriffstypen"]
