...
[role="lead"]
Sie können die Methode verwenden `GetDriveHardwareInfo`, um alle Hardwareinformationen für das angegebene Laufwerk zu erhalten. Dazu gehören im Allgemeinen Hersteller, Anbieter, Versionen und weitere zugehörige Hardware-Identifikationsinformationen.
