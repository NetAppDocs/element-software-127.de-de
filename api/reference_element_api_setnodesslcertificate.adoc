...
summary: Sie können die Methode SetNodeSSLCertificate verwenden, um ein Benutzer-SSL-Zertifikat und einen privaten Schlüssel für den Management-Knoten festzulegen. 
---
...
NOTE: Nach Verwendung der API müssen Sie den Management-Node neu booten.
...
PrivateKey
 a| 
Die PEM-codierte Textversion des privaten Schlüssels.
 a| 
Zeichenfolge
 a| 
Keine
